...
app = FastAPI()
from configs.databse import version_collection_name,current_collection_name
...
#     "version_number" : 1
# }
# result = version_collection_name.insert_one(document)

# current_collection_name.update_many(
#     {},
#     {'$set': {'is_active': True}}
# )
